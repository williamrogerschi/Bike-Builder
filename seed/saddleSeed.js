...
const bikeSaddles = [
  ...
  },
  {
    ...
    brand: `Fi'zi:k`,
    description: 'Our short-nose performance cycling racing saddle featuring 3D-printed padding for zonal cushioning comfort across the entire surface and full-carbon shell and rails to save weight without sacrificing support.',
    color: 'Black',
    image: 'https://d2wax9jsznmsse.cloudfront.net/media/catalog/product/cache/62da096d30b285fe6809aca988e7de16/f/i/fizik-2-vento-argo-adaptive-00-140-black-road-cycling-saddle_1.jpg',
    level: [pro._id],
    price: '$400',
  },
  {
  ...
  },
  {
    ...
    color: 'Black',
    image: 'https://cdn11.bigcommerce.com/s-ubg9970srq/images/stencil/1280x1280/products/194/2345/064A521REC003_Model__X_Green_superflow_L_L3_THREE_QUARTER__82602.1681801255.jpg?c=1',
    level: [entry._id],
    price: '$50',
  }
]
