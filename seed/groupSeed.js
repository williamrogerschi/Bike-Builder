  ...
  try {
    ...
    const bikeGroups = [
      ...
      },
      {
        ...
        brand: 'SRAM',
        description: 'SRAM Force eTap AXS offers the key features of RED eTap AXS—modern gearing, advanced chain management, and easy personalization—in a more affordable package.',
        material: [carbon._id],
      ...
      },
      {
        ...
        brand: 'Shimano',
        description: 'Brings Di2 performance, 12-speed wireless shifting for riders seeking reliability',
      ...
      },
      {
        name: 'Shimano R8000',
        brand: 'Shimano',
        description: 'Proven trickle-down tech from DURA-ACE, stress-free operation for all-day comfort in biking components.',
        material: [aluminum._id],
        image: 'https://m.media-amazon.com/images/I/514QKQgiQoL._AC_UF1000,1000_QL80_.jpg',
        level: [intermediate._id],
        price: '$900',
      },
      {
        name: 'SRAM Rival 22',
        brand: 'SRAM',
        description: 'Versatile groupset for diverse biking disciplines, offering efficiency, tech, and adaptability to push limits.',
        material: [aluminum._id],
