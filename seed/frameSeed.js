		...
		const bikeFrames = [
			{
				...
				material: [carbon._id],
				image:
					'https://embed.widencdn.net/img/dorelrl/0zavucjihn/2000px@1x/C23_C11082U_LAB71_SuperSix_EVO_AM_Frm_BLK_PD.png',
				level: [pro._id],
				price: '$6000',
			},
			{
				...
				material: [carbon._id],
				image:
					'https://ibkbike.vtexassets.com/arquivos/ids/990601/77224-02_AETHOS-SW-FRMSET-CLY-PDRNDGO-CMLNLPS_HERO.jpg?v=638321540913630000',
				level: [pro._id],
				price: '$5500',
			},
			{
				...
				material: [carbon._id],
				image:
					'https://www.theproscloset.com/cdn/shop/files/frd13085_PH3_3_3000x2000.jpg?v=1692816634',
			...
			},
			{
				...
				material: [carbon._id],
				image:
					'https://www.theproscloset.com/cdn/shop/files/FRD13057_PH3_3_3000x2000.jpg?v=1689712026',
				level: [intermediate._id],
				price: '$2000',
			},
			{
				...
				brand: 'Cannondale',
				description:
					'This is the speediest, smoothest, best handling, finest performing aluminum race frameset on the planet.',
				color: 'Glacier Blue',
				material: [aluminum._id],
				image:
					'https://embed.widencdn.net/img/dorelrl/zrzoqesxiy/2000px@1x/C22_C13582U_CAAD13_Frm_GLB_PD.png',
				level: [entry._id],
				price: '$850',
			},
		]
