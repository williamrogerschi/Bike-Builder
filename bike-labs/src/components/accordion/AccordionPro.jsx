	...
	return (
		<Accordion className="pro-acc">
          ...
          <div className='use-content-pro'>
					<p className='p-1'>
						<strong>Frame Material and Design</strong> Typically constructed from lightweight,
						high-end materials like carbon fiber or titanium to ensure maximum
						strength, stiffness, and minimal weight.
					</p>
					<p className='p-1'>
						<strong>Advanced Components</strong> Equipped with top-tier groupsets, including
						premium drivetrains, brakes, wheelsets, and other components that
						offer precise gear shifting, excellent braking, and superior
						aerodynamics.
					</p>
					<p className='p-1'>
					<strong>Aerodynamic Design:</strong> Frames and components are optimized for
		  ...
		  <p className='p-1'>
          <strong>Use Cases</strong> These bikes are intended for road racing and are designed to excel in various terrains, including flat roads, steep climbs, and technical descents, allowing professional cyclists to compete at the highest level.</p>
		  <p className='p-1'>
          <strong>Cost</strong>The cost of a "Pro World Tour" cycling bike can vary significantly based on brand, components, materials used, and customization. Typically, these bikes range from several thousand dollars to tens of thousands of dollars. It's not uncommon for professional riders to use bikes worth $10,000 or more, with some custom-built bikes reaching much higher price points.</p>
		  </div>
