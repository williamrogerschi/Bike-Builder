...
//     }
  ...
  >
    ...
    <Form className="shadow p-4 bg-white rounded" onSubmit={handleSubmit}>
        ...
        {!loading ? (
          <Button className="w-100" style={buttonStyle} onClick={() => loginUser()} variant="light" type="submit">
            Log In
          </Button>        
        ) : (
        ...
        <Button className="w-100" style={buttonStyle} variant="light" onClick={props.onClose}>Close</Button>
      </Form>
    </div>
  );
};
